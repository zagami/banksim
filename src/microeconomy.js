...
TrxMgr = (function() {
      ...
      if (!bank.gameover) {
        results.push((function() {
          ...
          for (k = 0, len2 = ref1.length; k < len2; k++) {
            ...
            c.giral += debt_bank;
            c.income += debt_bank;
            results1.push(bank.capital -= debt_bank);
          }
          return results1;
        })());
      }
        ...
        results.push((function() {
          ...
          for (k = 0, len2 = ref1.length; k < len2; k++) {
            ...
            if (c.giral < debt_cust) {
              ...
              c.giral = 0;
              results1.push(c.expenses += debt_cust);
            } else {
              c.giral -= debt_cust;
              c.expenses += debt_cust;
              results1.push(bank.capital += debt_cust);
            }
          }
          return results1;
        })());
  ...
  TrxMgr.prototype.get_cb_deposit_interests = function() {
    ...
    this.state.reserves += pr_giro * this.state.reserves;
    ref = this.banks;
    results = [];
    for (j = 0, len1 = ref.length; j < len1; j++) {
      bank = ref[j];
