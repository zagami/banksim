...
var Bank, BankCustomer, CentralBank, DFLT_INITIAL_DEPOSIT_PER_CUST, InterbankMarket, MAX_CUSTOMERS, MicroEconomy, Params, State, Statistics, TrxMgr, assert, random_array, randomize, randomizeInt;
...
CentralBank = (function() {
  ...
  function CentralBank(state, banks) {
    ...
    this.state = state;
    this.banks = banks;
    this.debt_free_money = 0;
    ref = this.banks;
    for (j = 0, len1 = ref.length; j < len1; j++) {
      bank = ref[j];
      this.debt_free_money += bank.reserves - bank.cb_debt;
    }
    this.debt_free_money += this.state.reserves;
  }
  ...
  CentralBank.prototype.assets_total = function() {
    var assets;
    return assets = this.debt_free_money + this.credits_banks();
  };
...
InterbankMarket = (function() {
  ...
  InterbankMarket.prototype.settle_interbank_interests = function(libor) {
    var b, j, k, key, len1, len2, ref, ref1, val;
    assert(this.interbank !== null, "interbank null");
    ref = this.interbank.keys();
    for (j = 0, len1 = ref.length; j < len1; j++) {
      b = ref[j];
...
TrxMgr = (function() {
  ...
  TrxMgr.prototype.create_transactions = function() {
    var all_customers, amount, cust1, cust1_index, cust2, cust2_index, j, num_customers, num_trx, ref, trx;
  ...
  TrxMgr.prototype.get_cb_deposit_interests = function() {
    var bank, c, interest, j, k, len1, len2, pr_giro, ref, ref1;
  ...
  TrxMgr.prototype.pay_cb_credit_interests = function() {
    var bank, debt, diff, j, len1, pr, ref;
  ...
  TrxMgr.prototype.manage_bank_debt = function() {
    var bank, creditor, debt, j, k, len1, len2, libor, max_new_loan, max_payback, new_loan, payback, pr, prg, ref, ref1, remainder;
    pr = this.params.prime_rate;
  ...
  TrxMgr.prototype.manage_customer_credits = function() {
    var c, cr, dr, j, len1, max_new_loan, max_payback, new_loan, payback, ref, sr;
  ...
  TrxMgr.prototype.disable_positive_money = function() {
    var bank, cb_debt_reduction, j, len1, ref;
