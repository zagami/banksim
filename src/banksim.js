...
var AUTORUN_DELAY, BanksChart, BanksDebtChart, BanksTable, BanksTotalChart, CHART_WIDTH, COL1, COL2, COL3, COL4, CentralBankChart, CentralBankTable, ChartVisualizer, CustomerGraph, CustomerTotalChart, CustomersTable, DICT, GraphVisualizer, INFLATION_HIST, InflationChart, InterestGraph, LANG, MONEY_SUPPLY_HIST, MoneySupplyChart, MoneySupplyTable, Simulator, StateTable, TableVisualizer, TaxesChart, Visualizer, VisualizerMgr, WealthDistributionChart, iv, simulator, translate,
...
Simulator = (function() {
  Simulator.prototype.init = function() {
    ...
    vizArray = [new CentralBankTable(this.microeconomy, '#cb_table', 'central bank'), new StateTable(this.microeconomy, '#state_table', 'state'), new CustomersTable(this.microeconomy, '#customers_table', 'customers'), new MoneySupplyTable(this.microeconomy, '#ms_table', 'money supply'), new BanksTable(this.microeconomy, '#banks_table', 'banks'), new BanksChart(this.microeconomy, '#banks_chart', 'all banks'), new BanksTotalChart(this.microeconomy, '#banks_total_chart', 'banks consolidated'), new BanksDebtChart(this.microeconomy, '#banks_chart2', 'central bank deposits'), new CustomerTotalChart(this.microeconomy, '#customers_total_chart', 'customers consolidated'), new CentralBankChart(this.microeconomy, '#cb_chart', 'central bank'), new MoneySupplyChart(this.microeconomy, '#stats_chart1', 'money supply'), new InflationChart(this.microeconomy, '#stats_chart2', 'inflation'), new TaxesChart(this.microeconomy, '#taxes_chart', 'taxes'), new WealthDistributionChart(this.microeconomy, '#wealth_chart', 'wealth distribution'), new InterestGraph(this.microeconomy, '#interest_graph', 'flow of interest')];
...
CustomersTable = (function(superClass) {
  ...
  CustomersTable.prototype.create_table = function() {
    ...
    this.create_row('income', incomes.sum().toFixed(2));
    this.create_row('expenses', expenses.sum().toFixed(2));
    return this.create_row('average income', (incomes.sum() / len).toFixed(2));
  };
...
StateTable = (function(superClass) {
  ...
  StateTable.prototype.create_table = function() {
    ...
    if (len > 0) {
      this.create_row('taxes current year', this.state.income_tax_series.last().toFixed(2));
      this.create_row('basic income total', this.state.basic_income_series.last().toFixed(2));
      basic_incom_per_citizen = this.state.basic_income_series.last() / num_citizens;
      this.create_row('basic income per citizen', basic_incom_per_citizen.toFixed(2));
      this.create_row('domestic growth product', this.stats.gdp_series.last().toFixed(2));
    }
...
BanksTable = (function(superClass) {
  ...
  BanksTable.prototype.create_bank_header = function() {
    return this.create_header('', translate("reserves"), '%', translate('interbank credits'), translate('credits'), translate('stocks'), translate('debt to central bank'), translate('interbank debt'), translate('bank deposits'), translate('savings'), translate("capital"), translate("assets"), translate("liabilities"), translate('number of clients'));
  };
...
CentralBankChart = (function(superClass) {
  ...
  CentralBankChart.prototype.set_options = function() {
    CentralBankChart.__super__.set_options.apply(this, arguments);
    return this.y_max = 2 * this.stats.m2();
  };
...
BanksTotalChart = (function(superClass) {
  ...
  BanksTotalChart.prototype.set_options = function() {
    BanksTotalChart.__super__.set_options.apply(this, arguments);
    return this.y_max = 2 * this.stats.m2();
  };
...
CustomerTotalChart = (function(superClass) {
  ...
  CustomerTotalChart.prototype.set_options = function() {
    CustomerTotalChart.__super__.set_options.apply(this, arguments);
    return this.y_max = 2 * this.stats.m2();
  };
