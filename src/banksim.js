...
Simulator = (function() {
  Simulator.prototype.init = function() {
    ...
    vizArray = [new CentralBankTable(this.microeconomy, '#cb_table', 'central bank'), new StateTable(this.microeconomy, '#state_table', 'state'), new MoneySupplyTable(this.microeconomy, '#ms_table', 'money supply'), new BanksTable(this.microeconomy, '#banks_table', 'banks'), new BanksChart(this.microeconomy, '#banks_chart', 'all banks'), new BanksTotalChart(this.microeconomy, '#banks_total_chart', 'banks consolidated'), new BanksDebtChart(this.microeconomy, '#banks_chart2', 'central bank deposits'), new CustomerTotalChart(this.microeconomy, '#customers_total_chart', 'customers consolidated'), new CentralBankChart(this.microeconomy, '#cb_chart', 'central bank'), new MoneySupplyChart(this.microeconomy, '#stats_chart1', 'money supply'), new InflationChart(this.microeconomy, '#stats_chart2', 'inflation'), new WealthDistributionChart(this.microeconomy, '#wealth_chart', 'wealth distribution'), new InterestGraph(this.microeconomy, '#interest_graph', 'flow of interest')];
...
CustomerTotalChart = (function(superClass) {
  ...
  CustomerTotalChart.prototype.update_data = function() {
    var c, capital, customers, girals, loans, savings;
