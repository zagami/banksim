...
var AUTORUN_DELAY, CHART_WIDTH, DICT, GraphVisualizer, INFLATION_HIST, LANG, NUM_BANKS, Params, Simulator, TableVisualizer, Visualizer, VisualizerMgr, iv, params, simulator, translate,
...
Params = (function() {
  ...
  Params.prototype.autorun = iv(false);
  ...
  Params.prototype.prime_rate = iv(2);
  ...
  Params.prototype.credit_interest = iv(3);
