...
var AUTORUN_DELAY, BanksChart, BanksDebtChart, BanksNumCustomersChart, BanksTable, COL1, COL2, COL3, COL4, CentralBankTable, ChartVisualizer, DICT, GraphVisualizer, INFLATION_HIST, InflationChart, InterestGraph, LANG, MONEY_SUPPLY_HIST, MainChart, MoneySupplyChart, MoneySupplyTable, Simulator, StatisticsTable, TableVisualizer, TaxesChart, Visualizer, VisualizerMgr, WealthDistributionChart, _tr, add_tr, iv, simulator,
...
Simulator = (function() {
  ...
  Simulator.prototype.init = function() {
    ...
    vizArray = [new CentralBankTable(this.microeconomy, '#cb_table'), new StatisticsTable(this.microeconomy, '#state_table'), new MainChart(this.microeconomy, '#main_chart'), new MoneySupplyTable(this.microeconomy, '#ms_table'), new BanksTable(this.microeconomy, '#banks_table'), new BanksChart(this.microeconomy, '#banks_chart'), new BanksDebtChart(this.microeconomy, '#banks_chart2'), new BanksNumCustomersChart(this.microeconomy, '#banks_chart3'), new MoneySupplyChart(this.microeconomy, '#stats_chart1'), new InflationChart(this.microeconomy, '#stats_chart2'), new TaxesChart(this.microeconomy, '#taxes_chart'), new WealthDistributionChart(this.microeconomy, '#wealth_chart'), new InterestGraph(this.microeconomy, '#interest_graph')];
